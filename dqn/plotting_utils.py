...
class MetricsTracker:
    ...
    def log_episode(self, episode, reward, length, loss=None, q_mean=None, epsilon=None):
...
class PlottingUtils:
    ...
    def plot_training_curves(self, save=False, save_dir="plots"):
        ...
        # Losses
        valid_losses = [(ep, loss) for ep, loss in zip(self.metrics.episodes, self.metrics.episode_losses) if loss > 0]
        if valid_losses:
