...
class TrainingConfig:
    ...
    def _add_replay_buffer_arguments(parser):
        ...
        parser.add_argument("--replay-buffer-num-workers", type=int, default=0)
...
class CQNTrainer(Logger):
    ...
    def _should_save_checkpoint(self):
        ...
        return self._global_step % self.config.checkpoint_interval == 0

    def _should_save_metrics(self):
        return self._global_step % self.config.metric_interval == 0
